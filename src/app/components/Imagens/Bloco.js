                ...
                <div className = "imagens-container">
                    {
                        imagens.map ((src, idx) => (
                            <div 
                                className = "imagem-container flex-center"
                                style = {{backgroundImage: `url("${api}/public/images/${src}")`}}
                                chave = {idx}>
                                <div className = "imagem-remover flex-center" onClick = {() => onRemove (idx)}>
                                    <span> {"-"} </span>
                                </div>
                            </div>
                        ))
    ...
    render () {
        ...
        return (
            <div className = "Bloco-Imagem">
                ...
                <div className = "flex vertical">
                    <label> <strong> Insira aqui uma nova imagem: & nbsp; </strong> </label>
                    <input type = "file" onChange = {handleSubmit} />
                </div>
                <hr /> <br />
                <div className = "imagens-container">
