    ...
    render () {
        ...
        (produtos ? produtos.docs : []).forEach((item) => {
            dados.push ({
                ...
                "Disponivel": (item.disponibilidade ? "Sim": "não"),
                ...
                <div className = "Card">
                    ...
                    <div className = "flex">
                        ...
                        <div className = "flex-1 flex vertical">
                            ...
                            <select valor = {ordem} onChange = {this.changeOrdem}>
                                <option value = {""}> Aleatório </option>
                                <option value = {"alfabetica_a-z"}> Alfabética AZ </option>
                                <option value = {"alfabetica_z-a"}> Alfabética ZA </option>
...
//import * como ações from '../../actions/produtos';
...
//exportar conexão padrão (mapStateToProps, ações) (Produtos);
