    ...
    render () {
        ...
        return (
            <div className = "Variacoes flex vertical flex-center">
                <Titulo type = "h2" titulo = "Variações" />
                {
                    (variacoes || []).map((item, idx) => (
                        <div
                            onClick = {() => this.getVariacao (item._id)} chave = {idx}
...
//importar * como ações de '../../../actions/variacoes';
...
//exportar conexão padrão (mapStateToProps, ações) (Variacoes);
