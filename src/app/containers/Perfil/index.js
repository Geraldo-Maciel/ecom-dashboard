...
//    construtor (adereços) {
    ...
    onChangeInput = (campo, valor) => this.setState ({[campo]: valor}, () => this.validate ())
    ...
    updateUsuario () {
        ...
        this.props.updateUser (dados, (erro) => {
            if (!erro) this.setState ({senhaAntiga: "", novaSenha: "", confirmarNovaSenha: ""});
            this.setState ({
                aviso: {
                    status:! erro,
                    msg: erro ? erro : "Dados padrão com sucesso"
//                    msg: erro ? mesage : "Dados padrão com sucesso"
                }
            })
        })
    }
...
//import * como ações de '../../ações';
//import AlertGeral de '../../components/Alert/Geral';
...
//exportar conexão padrão (mapStateToProps, ações) (Perfil);
